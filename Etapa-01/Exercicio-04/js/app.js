...
const my3FavoriteTVShows = ["Star Wars", "007", "Indiana Jones"];
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(", ").replace(", I", " e I")}.`
//console.log(sentence);
//FIZ - Certo, porém ele fez de outra forma mais simples. Curti esse replace. Se mudasse o nome do item não continuaria servindo - 1/2
...
const numeroCaracteres = 39;
let comparacaoCaracteres = typeSentence.length > numeroCaracteres;
comparacaoCaracteres = String(comparacaoCaracteres).replace("t","T");

//console.log(`A string que a "typeSentence" armazena tem mais de ${numeroCaracteres} caracteres? ${comparacaoCaracteres}`)
//FIZ - Certo, porém ele fez de outra forma mais simples. 1/2 certo.
...
//console.log(crazyConversion, "Qualquer valor resultaria true, com exceção dos valores falsy")
//FIZ - Certo :)
...
let isNotAString = typeof randomTVShow;
isNotAString = isNotAString != "string"
//console.log(isNotAString);
// FIZ - Certo, porém ele fez de outra forma mais simples - 1/2 ponto
...
//PONTOS: 8
//Agora vou revisar a etapa 1 toda!!!